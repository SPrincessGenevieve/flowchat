  ...
  return (
    <div>
      ...
      <section className="mt-8">
        <div className="relative aspect-video w-full overflow-hidden rounded-xl border border-primary-blue-100 bg-muted shadow-sm">
          <iframe
      ...
      <section className="mt-8 space-y-2">
        <h2 className="text-xl text-white font-semibold tracking-tight mb-4">
        ...
        >
          <div className="mt-2 space-y-1.5 text-sm">
            ...
            <div className="flex items-center gap-2 text-white/70">
              <span className="font-bold text-white/70">Not Interested</span>
              <span className="text-white/70/50">—</span>
              <span>Mark as Not Qualified. Do not re-engage.</span>
            </div>
            <div className="flex items-center gap-2 text-white/70">
              <span className="font-bold text-white/70">Stops Replying</span>
              <span className="text-white/70/50">—</span>
              <span>
      ...
      <section className="mt-10 space-y-4">
        ...
        <div className="space-y-3">
          {[
            ...
            <div
              key={s.step}
              className="rounded-lg bg-black/20 border border-primary-blue-100/40 p-4 flex gap-4"
            >
              <span className="shrink-0 rounded-md bg-primary-blue-100 px-2 py-0.5 text-xs font-bold text-white/70 h-fit">
                {s.step}
              </span>
              <div>
                <div className="flex items-baseline gap-2 flex-wrap">
                  <p className="text-sm font-semibold text-white">{s.label}</p>
                  <span className="text-xs text-white/70">{s.timing}</span>
                </div>
      ...
      <section className="mt-10 space-y-4">
        ...
        <div className="space-y-3">
          {[
            ...
            <div
              key={s.step}
              className="flex items-start gap-4 rounded-lg border border-primary-blue-100 p-3.5"
            >
              <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-primary-blue-100 text-primary-foreground text-xs font-bold">
                {s.step}
              </span>
              <div>
                <p className="text-sm font-semibold text-white">{s.label}</p>
      ...
      <section className="mt-10 space-y-4">
        ...
        <div className="rounded-lg border border-primary-blue-100 divide-y">
          {[
            {
            ...
            <div
              key={item.rule}
              className="px-4 py-3.5 flex gap-4  border-primary-blue-100"
            >
