    ...
    <div>
      ...
      <section className="space-y-10">
        ...
        <div>
          ...
          <div className="rounded-lg border border-primary-blue-100/40 bg-black/1\20 p-4">
            <p className="text-sm font-semibold text-white mb-2">
              VA Responsibilities — Lead Sources
            </p>
            <ul className="space-y-1.5 text-sm text-white/70">
              <li className="flex gap-2">
                <span className="text-primary-blue-100 font-bold shrink-0">
                  ›
                </span>{" "}
        ...
        <div>
          ...
          <div className="rounded-lg border border-primary-blue-100 divide-primary-blue-100 divide-y">
            {[
              {
                label: "Define ICP",
                detail:
        ...
        <div>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="rounded-lg bg-black/20 border border-primary-blue-100/40 p-4 space-y-3">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex items-center gap-2 text-white/70">
                  ...
                  <span>Not accepted, removed after 3 weeks</span>
                </div>
                <div className="flex items-center gap-2 text-white/70">
            ...
            <div className="rounded-lg bg-black/20 border border-primary-blue-100/40 p-4 space-y-3">
              <p className="text-sm font-semibold text-white">First Message</p>
              <div className="space-y-2 text-sm">
                <div className="flex items-center gap-2 text-white/70">
                  <span className="font-bold text-red-500">No</span>
                  <span className="text-white/70/50"></span>
