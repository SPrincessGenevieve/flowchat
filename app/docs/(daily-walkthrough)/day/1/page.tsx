    ...
    <div>
      ...
      <section className="space-y-8">
        <div>
          ...
          <div className="rounded-lg border border-primary-blue-100/40 bg-black/20 p-5">
        ...
        <div>
          ...
          <div className="space-y-3">
            {[
              ...
              <div
                key={s.step}
                className="rounded-lg border border-primary-blue-100/40 bg-black/20 p-4 flex items-start gap-4"
              >
                <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-primary-blue-100 text-white text-xs font-bold">
                  {s.step}
                </span>
                <div>
