    ...
    <div>
      ...
      <section className="space-y-10">
        ...
        <div>
          ...
          <div className="grid gap-3 sm:grid-cols-3">
            {[
              ...
              <div
                key={item.label}
                className="rounded-lg border border-primary-blue-100/40 bg-black/20 p-4"
              >
        ...
        <div>
          ...
          <div className="space-y-2.5">
            {[
              ...
              <div
                key={item.check}
                className="flex items-start gap-3 rounded-lg border border-primary-blue-100 p-3.5"
              >
                <div className="mt-0.5 h-4 w-4 shrink-0 rounded border-2 border-primary-blue-100/70" />
                <div>
        ...
        <div>
          ...
          <div className="rounded-lg border divide-y border-primary-blue-100 divide-primary-blue-100">
            {[
              {
              ...
              <div key={item.trigger} className="px-4 py-3.5 flex gap-4">
                <p className="w-52 shrink-0 text-sm font-semibold text-white">
                  {item.trigger}
                </p>
        ...
        <div>
          ...
          <div className="space-y-3">
            {[
              ...
              <div
                key={item.req}
                className="rounded-lg border border-primary-blue-100/70 p-4 flex gap-4"
              >
                <div>
          ...
          <Callout type="tip" title="Scaling Principle">
            ...
            when volume increases, only the inputs do. Keep the structure clean.
          </Callout>
        </div>
      </section>
    </div>
