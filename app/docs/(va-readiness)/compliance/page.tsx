  ...
  return (
    <div>
      ...
      <section className="mt-8 space-y-10">
        ...
        <div>
          <h2 className="text-xl text-white font-semibold tracking-tight mb-2">
            Friend Request Limits
          </h2>
        ...
        <div>
          ...
          <div className="mt-4 rounded-lg border border-primary-blue-100/30 bg-black/30 p-4">
            <p className="text-sm font-semibold text-white mb-2">
              If a messaging restriction occurs:
            </p>
            <ol className="space-y-1.5 text-sm text-white/70 list-decimal list-inside">
        ...
        <div>
          ...
          <div className="space-y-3">
            {[
              ...
              <div
                key={item.signal}
                className="rounded-lg border border-primary-blue-100/30 bg-black/30 p-4 flex gap-4"
              >
                <div className="flex-1">
                  <p className="text-sm font-semibold text-red-600 dark:text-red-400">
                    {item.signal}
                  </p>
                  <p className="text-sm text-white/70 mt-1">{item.action}</p>
                </div>
              </div>
            ))}
          </div>
