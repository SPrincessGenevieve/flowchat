    ...
    <div>
      ...
      <section className="mb-10">
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          {[
            ...
            <div
              key={item.rule}
              className="rounded-lg border bg-primary-blue-100/20 border-primary-blue-100 p-3.5"
            >
      ...
      <section className="mb-10">
        ...
        <div className="space-y-4">
          {objections.map((obj) => (
            <div
              key={obj.trigger}
              className="rounded-lg border border-primary-blue-100 overflow-hidden"
            >
              <div className="bg-primary-blue-100/20 px-4 py-3 border-b border-primary-blue-100">
                <p className="text-sm font-semibold text-white">
                  Lead says: <span className="text-white">{obj.trigger}</span>
                </p>
              </div>
              <div className="p-4 space-y-3">
                <div className="rounded-md bg-primary-blue-100/10 px-4 py-3">
                ...
                {"followup" in obj && obj.followup && (
                  <div className="rounded-md bg-primary-blue-100/20 px-4 py-3 border border-dashed border-primary-blue-200">
                    <p className="text-xs font-semibold uppercase tracking-widest text-white/70 mb-1">
                ...
                {obj.note && (
                  <p className="text-xs text-white/70 italic">{obj.note}</p>
                )}
              </div>
            </div>
          ))}
      ...
      <section className="mb-10">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="rounded-lg border border-primary-blue-100 p-4">
        ...
        <div className="mt-4 rounded-lg border border-primary-blue-100 bg-primary-blue-100/20 p-4">
          <p className="text-xs font-semibold uppercase tracking-widest text-white/70 mb-2">
