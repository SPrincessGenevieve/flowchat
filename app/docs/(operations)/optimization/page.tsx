        ...
        <div>
          ...
          <div className="space-y-3">
            {[
              ...
              <div
                key={item.metric}
                className="rounded-lg border bg-black/20 border-primary-blue-100/40 p-5"
              >
                <div className="flex items-start justify-between gap-4 flex-wrap">
                  <p className="font-semibold text-white">{item.metric}</p>
                  <span className="text-xs rounded-full bg-primary-blue-100/40 border-primary-blue-100 px-2 py-0.5 text-white/70">
                    {item.target}
                  </span>
                </div>
                ...
                <div className="mt-3 rounded-md bg-primary-blue-100/20 px-3 py-2 text-xs text-white/70">
                  <span className="font-semibold text-white">If low: </span>
                  {item.action}
                </div>
              </div>
            ))}
        ...
        <div>
          ...
          <div className="rounded-lg border border-primary-blue-100 divide-primary-blue-100 divide-y">
            {[
              ...
              >
                <p className="text-sm font-semibold text-white">{item.lever}</p>
