    ...
    <div>
      ...
      <section className="space-y-10">
        ...
        <div>
          ...
          <div className="space-y-3">
            {[
              ...
              <div
                key={item.title}
                className="rounded-lg border border-primary-blue-100/40 bg-black/20 p-4 flex gap-4"
              >
                <div className="mt-0.5 h-2 w-2 rounded-full bg-primary-blue-100 shrink-0 " />
                <div>
        ...
        <div className="">
          ...
          <div className="rounded-lg border border-primary-blue-100/40 bg-black/20 p-4 text-sm text-white/70 space-y-1.5">
            <p>
            ...
            <p>
              <span className="font-medium text-white">Update trigger:</span>{" "}
