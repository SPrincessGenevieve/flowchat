    ...
    <div>
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button
              ...
              className="gap-2 bg-linear-90 from-primary-blue-100 to-violet-400 border-none text-white"
            >
              <IconDownload className="h-4 w-4 text-white" />
              <Label>{downloading ? "Exporting…" : "Export Audit"}</Label>
              <IconChevronDown className="h-3 w-3 opacity-50" />
            </Button>
          </DropdownMenuTrigger>
          <DropdownMenuContent
            align="end"
            className="w-40 bg-primary-blue-500 border border-primary-blue-100 text-white"
          >
            <DropdownMenuItem
              className=""
      ...
      <div className="space-y-8">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div>
            ...
            <Input
              ...
              className="w-full rounded-[5px] border bg-primary-blue-100/20 border-primary-blue-200 text-white px-3 py-2 text-sm text-white  placeholder:text-white/70 focus:outline-none focus:ring-2 focus:ring-ring"
            />
          </div>
          <div>
            <label className="block text-xs font-semibold uppercase tracking-widest text-white/70 mb-1.5">
            ...
            <Input
              ...
              className="w-full rounded-[5px] border bg-primary-blue-100/20 border-primary-blue-200 text-white px-3 py-2 text-sm text-white  focus:outline-none focus:ring-2 focus:ring-ring"
            />
          </div>
        </div>

        {/* Phase selector */}
        <div className="rounded-[5px] border border-primary-blue-100 p-5">
          ...
          <div className="grid gap-2 sm:grid-cols-2 ">
            {stages.map((s) => (
              <label
                key={s}
                className={`flex items-center gap-3 rounded-[5px] border border-primary-blue-100 p-3 cursor-pointer transition-colors ${
                  selectedStage === s
                    ? "border-primary-blue-100 bg-primary-blue-100/20"
              ...
              >
                <Input
                  ...
                  className="h-5 accent-primary-blue-100"
                />
        ...
        <div className="rounded-[5px] border border-primary-blue-100 overflow-hidden">
          <div className="bg-primary-blue-100/20 px-4 py-3 border-b border-primary-blue-100">
          ...
          <div className="divide-y divide-primary-blue-100">
            {[
              ...
              >
                ...
                <p className="text-xs text-white/70">Target: {row.target}</p>
                <Input
                  value={row.value}
                  onChange={(e) => row.setter(e.target.value)}
                  placeholder={row.placeholder}
                  className="rounded-md border bg-primary-blue-100/20 border-primary-blue-200 text-white px-2.5 py-1.5 text-sm text-white  placeholder:text-white/70 focus:outline-none focus:ring-2 focus:ring-ring"
                />
              </div>
            ))}
          </div>
            ...
            {[
              ...
              >
                ...
                <Input
                  ...
                  onChange={(e) => row.setter(e.target.value)}
                  placeholder={row.placeholder}
                  className="w-32 rounded-md border bg-primary-blue-100/20 border-primary-blue-200 text-white px-2.5 py-1.5 text-sm text-white  placeholder:text-white/70 focus:outline-none focus:ring-2 focus:ring-ring"
                />
              </div>
            ))}
          </div>
        ...
        {/* Quality Control */}
        <div className="rounded-[5px] border border-primary-blue-100 overflow-hidden">
          <div className="flex items-center justify-between bg-primary-blue-100/20 px-4 py-3 border-b border-primary-blue-100">
            <p className="text-sm text-white font-semibold ">
          ...
          <div className="divide-y divide-primary-blue-100">
            {qualityItems.map((item) => (
              ...
              >
                ...
                <div>
                  <p
                    className={`text-sm text-white font-medium transition-colors ${quality[item.id] ? "line-through text-white/70" : ""}`}
                  >
                    {item.label}
                  </p>
        ...
        <div className="space-y-4">
          <div>
            <label className="block text-sm text-white font-semibold  mb-1.5">
            ...
            <textarea
              ...
              className="w-full rounded-[5px] border bg-primary-blue-100/20 border-primary-blue-200 text-white px-3 py-2 text-sm text-white  placeholder:text-white/70 focus:outline-none focus:ring-2 focus:ring-ring resize-none"
            />
          </div>
          <div>
            <label className="block text-sm text-white font-semibold  mb-1.5">
