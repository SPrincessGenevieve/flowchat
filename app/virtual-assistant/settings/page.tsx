  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <Card className="bg-primary-blue-100/10">
        <CardContent className="flex gap-4 flex-col">
          <CardHeader className="flex items-center gap-2 p-0">
            <IconUser className="text-white" size={18}></IconUser>
            <Label className="text-xl">Profile Information</Label>
          </CardHeader>
          <div className="mt-8 flex flex-col gap-4">
            <div className="grid grid-cols-4 gap-4 settings-cont">
      ...
      <Card className="bg-primary-blue-100/10">
        <CardContent className="flex gap-4 flex-col">
          <CardHeader className="flex items-center gap-2 p-0">
            <IconLock className="text-white" size={18}></IconLock>
