...
export const NoiseBackground = ({
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "group relative overflow-hidden rounded-2xl bg-linear-90 from-primary-blue-400 to-primary-blue-100 p-2 backdrop-blur-sm dark:bg-neutral-800",
